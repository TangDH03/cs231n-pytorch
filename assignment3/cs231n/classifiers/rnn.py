...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        #         # 2.7
        # if self.cell_type == 'rnn':
        #     dword_embedding_out, daffine_out, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(
        #     drnn_or_lstm_out, rnn_cache)
        # elif self.cell_type == 'lstm':
        #     dword_embedding_out, daffine_out, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(
        #       drnn_or_lstm_out, lstm_cache)
        # else:
        #     raise ValueError('Invalid cell_type "%s"' % self.cell_type)
        #         # 2.8
        ...
        if self.cell_type=='rnn':
          ...
          dword_embedding_out,daffine_out,grads['Wx'],grads['Wh'],grads['b'] = lstm_backward(drnn_out,lstm_cache)
        grads['W_embed'] = word_embedding_backward(dword_embedding_out,word_embedding_cache)
        dfeatures,grads['W_proj'],grads['b_proj'] = affine_backward(daffine_out,affine_cache)
